...
class ShowContactsInfoForEdit extends Component {
    state = { 
        contactForm: { 
            name: {
                elementType: "input",
       ...
       contactInfoHandler = (event) => {
            ...
            let phoneNumber     = contactFormData.phoneNumber
                ...
                this.props.onEditContact(name, email, streetAddress, postalCode, phoneNumber)
                this.props.closed()
    ...
    const mapDispatchToProps = dispatch => {
        return {
            onEditContact: (name, email, streetAddress, postalCode, phoneNumber) => dispatch(actions.editContact(name, email, streetAddress, postalCode, phoneNumber))
        };
    };
    
    
 
export default connect(mapStateToProps, mapDispatchToProps)(ShowContactsInfoForEdit);